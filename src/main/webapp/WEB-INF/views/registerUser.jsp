...
<form class="col-8" action="register" method="post">
	...
	<div class="row form-group">
		...
		<div class="col-5 form-check-inline">
			 <label class="radio-inline control-label">
				<input type="radio" name="usertype" value="Owner" class="form-check-input" checked>Owner
			</label>
			<label class="radio-inline control-label">
			<input type="radio" name="usertype" value="Client" class="form-check-input">Client
			</label>
		</div>
	</div>
	<div class="row form-group">
	...
	<div class="row form-group">
		...
		placeholder="zip" class="form-control" required>
		</div>
	</div>
